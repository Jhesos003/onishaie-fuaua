...
module.exports = {
  config: {
    name: "shoticron",
    author: "Jhe",//owner of api lib_Pogi
    version: "1.0.0",
    role: 2,
    shortDescription: "TikTok send every 1 minute",
    longDescription: "send TikTok video every 1 minute",
    category: "CRON",
    guide: "{pn}"
  },
          ...
          try {
            if (activeThreads[threadID]) {
              ...
              file.on('finish', () => {
                api.sendMessage(
                  {
                    body: `𝗥𝗔𝗡𝗗𝗢𝗠 𝗦𝗛𝗢𝗧𝗜 𝗘𝗩𝗘𝗥𝗬 1 𝗠𝗜𝗡𝗨𝗧𝗘𝗦\n\n𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲: ${username}\n𝗡𝗶𝗰𝗸𝗻𝗮𝗺𝗲: ${nickname}\n𝗗𝘂𝗿𝗮𝘁𝗶𝗼𝗻: ${duration}\n𝗚𝗿𝗼𝘂𝗽𝗜𝗗: ${tid}`,
